...
export default function UserTopBar() {
  ...
  const newPasswordMutation = useMutation(
    (data: NewPasswordData) => axiosInstance.put("/user/password", data),
    {
      onSuccess(data) {
  ...
  return (
    <>
      ...
      <div
        ...
        className={`bg-[#000000bd] sm:hidden ${
          display ? "block" : "hidden"
        } w-full z-[888] absolute top-0 left-0 h-full`}
      >
