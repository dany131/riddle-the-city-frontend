    ...
    <>
      <div className="flex flex-col gap-40">
        ...
        <div className="relative min-h-[30rem] ">
          ...
          <div className="px-32 pb-16 mt-16">
            <div className="relative min-h-[6rem] p-2">
              ...
              <div className="mt-8 flex flex-col px-16 gap-4">
                ...
                <div className="z-[4] relative flex justify-between">
                  <p className="text-4xl">Join the Ultimate Treasure Hunt Adventure!</p>
      ...
      <div className="relative min-h-[2rem] ">
        ...
        <div className="relative flex justify-around z-[4] p-2">
