    ...
    return (
        <>
            <div className="flex flex-col border-1 rounded-lg gap-4 p-4">
                ...
                <p className="text-gray-400 text-sm">We receive, collect and store any information you enter on our
                ...
                <p className="text-gray-400 text-sm">When you conduct a transaction on our website, as part of the
                ...
                <p className="text-gray-400 text-sm">We collect such Non-personal and Personal Information for the
                ...
                <p className="text-gray-400 text-sm">We may contact you to notify you regarding your account, to
