        ...
        <>
            <div className="flex flex-col gap-4 px-4 h-full">
                ...
                {!riddleQuery.isFetching && <div className="flex items-center flex-col gap-4">
                    ...
                    {!riddleIsCompleted && <Link href={`/startRiddle`} className="px-16 py-2 bg-[#A92223] w-max rounded flex justify-center text-white">Next Riddle</Link>}
                    {riddleIsCompleted && <button onClick={() => {
                        onOpen3()
                    }} className="px-16 py-2 bg-[#A92223] w-max rounded flex justify-center text-white">Claim Reward</button>}
                </div>}
                {/* <p>Scan Start</p> */}
            ...
            >
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader className="flex flex-col text-xl gap-1">Rewards Claimed Successfuly</ModalHeader>
