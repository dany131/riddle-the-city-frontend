    ...
    return (
        <>
            <div className="flex flex-col Voigante">
                ...
                <div className={`flex flex-col justify-between flex-wrap gap-4 px-8 sm:px-28 mt-16 ${montesserat.className}`}>
                    ...
                    <div className="flex gap-8 justify-center flex-wrap">
                        <div className="flex flex-col items-center  gap-[1.4rem]">
                            <div className="relative h-[15rem] w-[18rem]">
                                <Image className=" h-full w-full" src={'/images/aboutus/team1.svg'} width={80} height={80} alt="strawberry icon" />
                            </div>
