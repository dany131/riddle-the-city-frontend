      ...
      <div className="flex flex-col ">
        ...
        <div className="px-8 sm:px-4 pb-16 flex flex-col items-center gap-8 relative">
          ...
          <div className="z-[999]">
            ...
            <p className="font-semibold Voigante sm:text-start text-center">
              If purchasing a 3-Day Pass in Nashville please take a look at{" "}
              <a
                href="https://www.musiccitybrewhop.com/"
                target="_blank"
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-16">
            <div className="h-[25rem] Voigante relative min-w-[22rem] flex flex-col gap-4 items-center pt-16">
              <Image
                className="w-full object-contain h-full absolute z-[0]"
                src={"/images/home/featured-frame-box.png"}
                alt="frame box"
                width={300}
                height={300}
              />
              ...
              <div className="flex z-[1] flex-col gap-4 ">
                ...
                <div>
                  <p className="text-center text-lg">
                    72 hours of Hunts from the time
                  </p>
                </div>
                <div>
            ...
            <div className="h-[25rem] Voigante relative gap-4 min-w-[22rem] flex flex-col items-center pt-16">
              <Image
                className="w-full object-contain h-full absolute z-[0]"
                src={"/images/home/featured-frame-box.png"}
                alt="frame box"
            ...
            <div className="h-[25rem] Voigante relative min-w-[22rem] gap-4 flex flex-col items-center pt-16">
              <Image
                className="w-full object-contain h-full absolute z-[0]"
                src={"/images/home/featured-frame-box.png"}
                alt="frame box"
              ...
              />
              <div className="bg-[#1413135e] z-[1] min-w-[50%] p-4 mt-16">
                <p className="w-full text-center text-xl">Yearly Membership</p>
              </div>
              <div className="flex flex-col z-[1] gap-4 ">
                <div>
        ...
        <div className="flex justify-between flex-wrap gap-8 px-8 sm:px-28 mt-16">
          <div className="w-full lg:w-[40%]  flex flex-col gap-4 items-center justify-center">
            ...
            <div className="flex flex-col gap-4 sm:text-start text-center">
              <p className="text-6xl Voigante ">Riddle the City</p>
              <p className="text-sm">
              ...
              <p className="text-sm">
                ...
                And don’t worry, our treasures are all pretty cool.
              </p>
              <Link
        ...
        <div className="flex flex-col relative  mt-16">
          <Image
            ...
            style={{ opacity: "0.1" }}
            src={"/images/layout/clientBanner.svg"}
            alt="mystery"
            width={500}
            height={700}
          />
